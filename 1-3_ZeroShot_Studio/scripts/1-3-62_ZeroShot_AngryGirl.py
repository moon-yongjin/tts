...
# 2. 데이터 설정 (화난 목소리)
REF_AUDIO = "/Users/a12/projects/tts/references/Reference_015348.wav"
REF_TEXT = "아저씨 뭐 하시는 거예요 지금? 미쳤어요? 촬영 나 괜찮아?"
...
def main():
    print("🎙️ Zero-Shot Voice Clone [Angry Mode]")
    ...
    if len(combined_audio) > 0:
        output_name = f"ZeroShot_Angry_{datetime.datetime.now().strftime('%H%M%S')}"
