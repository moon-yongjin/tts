...
# 2. 데이터 설정 (사용자 확정 타로 보이스 레퍼런스)
REF_AUDIO = "/Users/a12/projects/tts/references/Tarot_Fixed_Ref.wav"
...
def main():
    print("🎙️ Zero-Shot Voice Clone [FIXED TAROT MODE]")
    ...
    if len(combined_audio) > 0:
        output_name = f"ZeroShot_FixedTarot_{datetime.datetime.now().strftime('%H%M%S')}"
