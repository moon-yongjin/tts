...
# 2. 데이터 설정 (새 TikTok-Lite 레퍼런스 - 0405)
REF_AUDIO = "/Users/a12/projects/tts/1-3_ZeroShot_Studio/voices/Reference/TikTokLite_0405_Ref.wav"
REF_TEXT = "결단력 있고 실행력 보이고 있는 이재명 정부와 밀어주시다."
...
def main():
    print("==========================================")
    print("🎙️ Qwen3-TTS [MLX] Zero-Shot V2 (TikTokLite_0405)")
    print("==========================================")
    ...
    if len(combined_audio) > 0:
        ...
        output_name = f"TikTokLite_V2_결과물_{timestamp}.wav"
