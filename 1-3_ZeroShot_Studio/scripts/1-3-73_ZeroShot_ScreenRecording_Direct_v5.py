...
# 🎙️ [SOP 가이드 준수] 제로샷 스크린녹화 연동 v5 (WAV 변환 없음)
...
# 2. 데이터 설정 (**원본 MP4 직접 사용**)
# 사용자 요청: 웨이브 변환하지 말고 그대로 사용
REF_AUDIO = "/Users/a12/Downloads/Screen_Recording_20260322_013938_TikTok-Lite.mp4"

# MLX-Whisper 자동 녹취 기반 텍스트 (피치 드롭 방안)
REF_TEXT = "BTS 공연을 간다고요? 그냥 거기를 지나간다고요? 잠시만요. 아래 캡션에 광화문 근처 관련"
...
def main():
    print("==========================================")
    print("🎙️ Qwen3-TTS [MLX] Zero-Shot ScreenRecording V5")
    print("==========================================")
    ...
    print(f"📁 [Direct] {os.path.basename(REF_AUDIO)} 로드 중...")
    # mp4 파일을 librosa로 직접 로드 (WAV 변환 불필요)
    ...
    for i, chunk in enumerate(chunks):
        ...
        try:
            ...
            if segment_audio_mx is not None:
                ...
                segment_pydub = segment_pydub + 4 # 💡 기본 음량 증폭 (+4dB)
    ...
    if len(combined_audio) > 0:
        ...
        output_path = OUTPUT_DIR / f"ScreenRecording_Direct_{timestamp}.wav"
