...
# 2. 데이터 설정 (유튜브 추출 레퍼런스)
REF_AUDIO = "/Users/a12/projects/tts/voices/Reference_Videos/Screen_Recording_20260318_040927_YouTube.mp4"

# 5초 단위 극강 크롭 + 클린 받아쓰기 대사
REF_TEXT = "사람들은 20달러가 동일한 가치처럼 느껴지겠지만 실제적으로 우리가 판매를 할 때 크로스보더 셀러, 우리 역직구의 셀러들은 이익을 더 많이 볼 수 있다라고."
...
def normalize_text(text):
    ...
    text = text.replace('. ', '.').replace('.', '.. ') # 🚀 마침표 뒤 강제 스페이스 (호흡 조절)
...
def main():
    print("==========================================")
    print("🎙️ Qwen3-TTS [MLX] 유튜브 추출 Zero-Shot")
    print("==========================================")
