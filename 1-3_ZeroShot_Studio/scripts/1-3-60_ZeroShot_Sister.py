...
# 2. 데이터 설정 (유튜브 녹화 기반 동생 목소리)
REF_AUDIO = "/Users/a12/projects/tts/references/Reference_013849.wav"
REF_TEXT = "근데 우리 오빠는 누군가 좋은 사람을 만나면 인생이 꽃필 스타일이야."
...
def main():
    print("🎙️ Zero-Shot Voice Clone [Sister Mode]")
    ...
    if len(combined_audio) > 0:
        output_name = f"ZeroShot_Sister_{datetime.datetime.now().strftime('%H%M%S')}"
