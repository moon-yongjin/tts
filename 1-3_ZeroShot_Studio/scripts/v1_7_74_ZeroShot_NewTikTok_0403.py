...
# 2. 데이터 설정 (New TikTok-Lite Ref 0403)
REF_AUDIO = "/Users/a12/Downloads/NewTikTok_Ref_0403.wav"
REF_TEXT = " 살 통통이 오른 가을 물고기 넣고 어탕을 끓입니다. 특별한 재료도 비법도 필요 없습니다."
...
def main():
    print("==========================================")
    print("🎙️ Qwen3-TTS [MLX] Zero-Shot (NewTikTok 0403)")
    print("==========================================")
    ...
    if len(combined_audio) > 0:
        ...
        output_prefix = "NewTikTok_0403_ZeroShot"
