...
# 2. 데이터 설정 (타로/무속인 목소리)
REF_AUDIO = "/Users/a12/projects/tts/references/Reference_015110.wav"
REF_TEXT = "봐봐, 진서진철 신이 엄마다 좀 봐봐. 내가 남자랑 찾는 게 상사이네? 내 일하고? 어? 아니야 봐봐 얘 입에 일하고 찾는 게 상사이네"
...
def main():
    print("🎙️ Zero-Shot Voice Clone [Tarot Mode]")
    ...
    if len(combined_audio) > 0:
        output_name = f"ZeroShot_Tarot_{datetime.datetime.now().strftime('%H%M%S')}"
