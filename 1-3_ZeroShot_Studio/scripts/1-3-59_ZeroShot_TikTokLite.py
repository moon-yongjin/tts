...
# 2. 데이터 설정 (TikTok-Lite 레퍼런스)
REF_AUDIO = "/Users/a12/Downloads/TikTokLite_Ref.wav"
REF_TEXT = "틱톡라이트 광고 혹은 영상에서 추출한 목소리 톤을 참고하기 위한 레퍼런스 데이터입니다."
...
def main():
    print("==========================================")
    print("🎙️ Qwen3-TTS [MLX] Zero-Shot Voice Clone (TikTokLite)")
    print("==========================================")
    ...
    if len(combined_audio) > 0:
        ...
        output_prefix = "TikTokLite_ZeroShot"
