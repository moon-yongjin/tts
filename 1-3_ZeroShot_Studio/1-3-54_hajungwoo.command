#!/bin/bash
# [1-3-54 Qwen3-TTS ZeroShot 실행 커맨드]
...
SCRIPT_PATH="/Users/a12/projects/tts/1-3_ZeroShot_Studio/scripts/qwen3-tts-apple-silicon/1-3-54_ZeroShot_YouTube_TTS.py"

clear
echo "--------------------------------------------------"
echo "🎙️ [STEP 1-3-54] Qwen3-TTS ZeroShot TTS 가동"
echo "--------------------------------------------------"
echo ""
