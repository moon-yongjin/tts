...
def get_consistent_prompts(script_chunk, prev_summary="None", retries=2):
    ...
    [STRICT VISUAL BIBLE - ALWAYS ADHERE TO THIS]
    - CHARACTER: {VISUAL_BIBLE.get('character_en', VISUAL_BIBLE.get('character', ''))}
    - BACKGROUND: {VISUAL_BIBLE.get('background_en', VISUAL_BIBLE.get('background', ''))}
    ...
    [CORE RULES] 
    1. PROMPT: Combine the Visual Bible data above with the specific action in the script part.
    2. CONSISTENCY: Do NOT deviate from the character or background description in the Bible.
    3. FOCUS: 16:9 cinematic composition.
    4. NO TEXT: No letters or watermarks.
