...
SPEAKER = "sohee"
SPEED = 1.0 # 수치형 속도 대신 페르소나 지시문으로 제어
INSTRUCT = "An extremely breathy and airy voice of a 40-year-old woman. The tone is solemn, tragic, and grave. She reads the text very fast, dynamically, and with intense emotional urgency."
